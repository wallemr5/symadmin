...
func (in *AppActual) DeepCopyInto(out *AppActual) {
	*out = *in
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]*AppActualItem, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AppActualItem)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppActualItem) DeepCopyInto(out *AppActualItem) {
	*out = *in
	if in.Ready != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppActualItem.
func (in *AppActualItem) DeepCopy() *AppActualItem {
	if in == nil {
		return nil
	}
	out := new(AppActualItem)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppAggr) DeepCopyInto(out *AppAggr) {
	*out = *in
	in.Desired.DeepCopyInto(&out.Desired)
	in.Actual.DeepCopyInto(&out.Actual)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppAggr.
func (in *AppAggr) DeepCopy() *AppAggr {
	if in == nil {
		return nil
	}
	out := new(AppAggr)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppDesired) DeepCopyInto(out *AppDesired) {
	*out = *in
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]*AppDesiredItem, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AppDesiredItem)
				**out = **in
			}
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppDesired.
func (in *AppDesired) DeepCopy() *AppDesired {
	if in == nil {
		return nil
	}
	out := new(AppDesired)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppDesiredItem) DeepCopyInto(out *AppDesiredItem) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppDesiredItem.
func (in *AppDesiredItem) DeepCopy() *AppDesiredItem {
	if in == nil {
		return nil
	}
	out := new(AppDesiredItem)
...
func (in *ClusterSpec) DeepCopyInto(out *ClusterSpec) {
	*out = *in
	if in.Additionals != nil {
		in, out := &in.Additionals, &out.Additionals
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
