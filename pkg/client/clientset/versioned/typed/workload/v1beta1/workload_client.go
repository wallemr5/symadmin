...
import (
	...
	"gitlab.dmall.com/arch/sym-admin/pkg/client/clientset/versioned/scheme"
...
// WorkloadV1beta1Client is used to interact with features provided by the workload group.
type WorkloadV1beta1Client struct {
	restClient rest.Interface
}

func (c *WorkloadV1beta1Client) Clusters(namespace string) ClusterInterface {
