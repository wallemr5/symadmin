...
helm-test:
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context test-tke-gz-bj5-bus-01 --install sym-ctl --namespace sym-admin --set image.tag=${VERSION},image.worker=true,image.master=true,image.reCreate=true,image.threadiness=1,resources.limits.cpu=1,resources.requests.cpu="500m" ./chart/sym-controller
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context test-tke-gz-bj5-glb --install sym-ctl --namespace sym-admin --set image.tag=${VERSION},image.worker=true,image.master=true,image.reCreate=true,image.threadiness=1,resources.limits.cpu=1,resources.requests.cpu="500m" ./chart/sym-controller
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context cn-tke-bj5-test-01 --install sym-ctl --namespace sym-admin --set image.tag=${VERSION},image.worker=true,image.master=true,image.reCreate=true,image.threadiness=1,resources.limits.cpu=1,resources.requests.cpu="500m" ./chart/sym-controller
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context dev-tke-bj5-monit-01 --install sym-ctl --namespace sym-admin --set image.tag=${VERSION},image.worker=true,image.master=true,image.reCreate=true,image.threadiness=1,resources.limits.cpu=1,resources.requests.cpu="500m" ./chart/sym-controller
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context test-tke-rz-bj5-bus-01 --install sym-ctl --namespace sym-admin --set image.tag=${VERSION},image.worker=true,image.master=false,image.reCreate=true,image.threadiness=1,resources.limits.cpu=1,resources.requests.cpu="500m" ./chart/sym-controller
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context test-tke-rz-cd-bus-01 --install sym-ctl --namespace sym-admin --set image.tag=${VERSION},image.worker=true,image.master=false,image.reCreate=true,image.threadiness=1,resources.limits.cpu=1,resources.requests.cpu="500m" ./chart/sym-controller
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context cn-tke-cd-test-01 --install sym-ctl --namespace sym-admin --set image.tag=${VERSION},image.worker=true,image.master=false,image.reCreate=true,image.threadiness=1,resources.limits.cpu=1,resources.requests.cpu="500m" ./chart/sym-controller
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context dev-tke-bj5-test-01 --install sym-ctl --namespace sym-admin --set image.tag=${VERSION},image.worker=true,image.master=false,image.reCreate=true,image.threadiness=1,resources.limits.cpu=1,resources.requests.cpu="500m" ./chart/sym-controller
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context test-tke-rz-cd-glb --install sym-ctl --namespace sym-admin --set image.tag=${VERSION},image.worker=true,image.master=false,image.reCreate=true,image.threadiness=1,resources.limits.cpu=1,resources.requests.cpu="500m" ./chart/sym-controller
	...
	helm upgrade --kubeconfig ${KUBECONFIG} --kube-context test-tke-gz-bj5-glb --install sym-api --namespace sym-admin --set image.tag=${VERSION},ingress.hosts[0].host=testapi-glb.sym.dmall.com,ingress.hosts[0].paths[0]=/,resources.limits.cpu=1,resources.requests.cpu="500m",replicaCount=1 ./chart/sym-api
